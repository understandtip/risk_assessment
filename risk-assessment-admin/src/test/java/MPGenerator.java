...
public class MPGenerator {
  public static void main(String[] args) {
    ...
    globalConfig.setOutputDir(
        System.getProperty("user.dir") + "/risk-assessment-admin/src/main/java");
    // 设置作者名字
    ...
    packageConfig.setParent("com.yushang.risk.admin"); // 自定义包的路径
    ...
    // todo 这里修改需要自动生成的表结构
    strategyConfig.setInclude("role_permission");
