 ...
 *
 * @name：NormalTest @Date：2024/1/16 16:05 @Filename：NormalTest
 */
public class NormalTest {
  ...
  void testPdf() {
    try {
      ...
      // 4.向文档中添加内容
      new NormalTest().generatePDF(document);
  ...
  public PdfPCell createCell(
      String value, Font font, int align, float[] borderWidth, float[] paddingSize, boolean flag) {
    PdfPCell cell = new PdfPCell();
    cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
    cell.setHorizontalAlignment(align);
    cell.setPhrase(new Phrase(value, font));
