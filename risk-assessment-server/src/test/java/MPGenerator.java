...
public class MPGenerator {
  public static void main(String[] args) {
    ...
    globalConfig.setOutputDir(
        System.getProperty("user.dir") + "/risk-assessment-server/src/main/java");
    // 设置作者名字
    globalConfig.setAuthor("zlp");
    ...
    packageConfig.setParent("com.yushang.risk.assessment"); // 自定义包的路径
    ...
    // todo 这里修改需要自动生成的表结构
    strategyConfig.setInclude("attr_menace");
  ...
  public static void assembleDev(DataSourceConfig dataSourceConfig) {
    ...
    dataSourceConfig.setPassword("17568913095zlp");
    dataSourceConfig.setUrl(
        "jdbc:mysql://127.0.0.1/risk_assessment?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
  }
}
